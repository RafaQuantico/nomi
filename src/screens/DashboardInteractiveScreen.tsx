...
export default function DashboardInteractiveScreen() {
  ...
  // 1. Filtrar datos (ahora solo usamos filtro por target, el agrupamiento es local)
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 28, fontFamily: "Inter_900Black", color: "#1F2937", letterSpacing: -0.5 },
  errorText: { color: 'red', marginBottom: 16 },
  retryBtn: { padding: 12, backgroundColor: '#000', borderRadius: 8 },
  retryText: { color: '#fff', fontFamily: "Inter_800ExtraBold" },
  ...
  metricValue: { fontSize: 32, fontFamily: "Inter_900Black", color: "#1F2937" },
  metricLabel: { fontSize: 13, color: "#4B5563", marginTop: 4, fontFamily: "Inter_600SemiBold" },
  ...
  filterText: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#4B5563" },
  ...
  sectionTitle: { fontSize: 18, fontFamily: "Inter_800ExtraBold", color: "#1F2937", marginBottom: 20 },
  sectionSubtitle: { fontSize: 14, color: "#4B5563", marginBottom: 16 },

  barsContainer: { gap: 20 },
  barRow: {},
  barLabelContainer: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  barLabel: { fontSize: 14, fontFamily: "Inter_700Bold", color: "#374151" },
  barValue: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#4B5563" },
  ...
  tagText: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#374151", marginRight: 6 },
  tagBadge: { backgroundColor: '#000', borderRadius: 10, paddingHorizontal: 6, paddingVertical: 2 },
  tagBadgeText: { color: '#fff', fontSize: 10, fontFamily: "Inter_800ExtraBold" },
});
